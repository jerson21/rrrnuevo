            ...
            <div class="modal-body">
                <form id="formEditarUsuario">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="edit_amaterno" name="amaterno">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="edit_privilegios" class="form-label">Rol</label>
                                <select class="form-select" id="edit_privilegios" name="privilegios">
                                    <option value="0">Tapicero</option>
